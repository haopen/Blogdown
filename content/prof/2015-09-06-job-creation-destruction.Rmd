---
title: 中国的『岗位创造』与『岗位破坏』 - 慧航 - 专栏
author: 慧航
date: 2015-09-06
categories: ["6-经济 - 劳动"]
tags: ["6-慧航", "6-知乎专栏", "6-文献笔记"]
slug: job-creation-destruction
---

**原文地址**：<https://zhuanlan.zhihu.com/p/20201591>

前几天介绍了关于中国失业率的文章：[中国失业率与劳动参与率的长期趋势 - EconPaper - 知乎专栏](http://zhuanlan.zhihu.com/econpaper/20174356)，而对于劳动市场的描述，除了失业率、劳动参与率之外，还有许多其他维度的指标，其中岗位创造（job creation）和岗位破坏（job destruction）是两个非常重要的维度。Hsieh and Klenow (2009) 指出中国和印度如果有和美国一样的资源配置效率，那么中国和印度的生产率将会极大的提升，因而理解劳动力的资源配置有非常重要的意义。
清华经管的 Hong Ma, Xue Qiao and Yuan Xu 等人最近在《Journal of Comparative Economics》上的文章：《Job creation and job destruction in China during 1998-2007》对这两个指标进行了系统的测算。

文章主要使用国家统计局的工业企业数据库对以上指标进行测算。作者首先定义了**职位增长率**：

$$
g_{et}=\left\{
\begin{aligned}
& 2(e_t-e_{t-1})/(e_t+e_{t-1}), && \text{if}\, e_{t-1},e_t>0\\
& -2, && \text{if}\, e_{t-1}>0,e_t=0\\
& 2,  && \text{if}\, e_{t-1}=0,e_t>0
\end{aligned}
\right.
$$
...
![](/images/Eco/Labor/huihang/JobCreationDestruction/1.jpg)

即那些就业人数正增长的企业的就业增长除以部门内的总就业人数。类似的，「岗位破坏」被定义为：

![](/images/Eco/Labor/huihang/JobCreationDestruction/2.jpg)
...
![](/images/Eco/Labor/huihang/JobCreationDestruction/3.jpg)

![](/images/Eco/Labor/huihang/JobCreationDestruction/4.jpg)
...
![](/images/Eco/Labor/huihang/JobCreationDestruction/5.jpg)
...
![](/images/Eco/Labor/huihang/JobCreationDestruction/6.jpg)
...
![](/images/Eco/Labor/huihang/JobCreationDestruction/7.jpg)
...
![](/images/Eco/Labor/huihang/JobCreationDestruction/8.jpg)

其中前两项为组内的 EXCESS，后两项为组间的 EXCESS 变动。

![](/images/Eco/Labor/huihang/JobCreationDestruction/9.jpg)
...
![](/images/Eco/Labor/huihang/JobCreationDestruction/10.jpg)

并使用 Arellano-Bond 方法进行估计。

![](/images/Eco/Labor/huihang/JobCreationDestruction/11.jpg)
