---
title: 中国的预防性储蓄估计：以国企改革打破“铁饭碗”作为自然实验 - 慧航 - 专栏
author: 慧航
date: 2014-09-04
categories: ["6-经济 - 微观计量"]
tags: ["6-慧航", "6-知乎专栏", "6-文献笔记", "6-应用微观计量", "6-家庭", "6-预防性储蓄"]
slug: iron-breaking-the-Rice-Bowl
---

**原文地址**：<https://zhuanlan.zhihu.com/p/19841390>

我校 Hui He, Feng Huang, Dongming Zhu 与旧金山联储的 Zheng Liu 合作的文章：[《Breaking the “Iron Rice Bowl” and Precautionary Savings: Evidence from Chinese State-Owned Enterprises Reform》](http://www.frbsf.org/economic-research/files/wp2014-04.pdf)使用上世纪末的国企改革作为自然实验，估算了中国家庭预防性储蓄的规模，摘要如下：
...
文献中识别预防性储蓄是非常困难的，因为识别家庭收入风险的原因本身就很困难。文章使用上世纪 90 年代的国企改革作为外生的冲击，比较了政府工作人员与国有企业工人的储蓄行为。因为`政府工作人员几乎不受到这次改革的影响，而国有企业工人的铁饭碗被打破，因而收入风险大大增加`。利用这一外生的政策变化，使用（类似于）DID 的方法，识别除了预防性储蓄的规模。

此外，此类文献一般受到 self-selection biases 的影响。为了去除自选择效应，作者`将样本限制在政府分配的工人中`，这样就不会存在风险偏好不同的工人选择不同种类工作的问题。

根据作者估计的结果，预防性储蓄大约构成了`30%`的家庭金融资产积累。