...
**原文地址**：<https://cosx.org/2017/05/bandit-and-recommender-systems/>
...
# 1.什么是bandit算法{#bandit-1}

## 1.1 为选择而生{#for-choose}

我们会遇到很多选择的场景。上哪个大学，学什么专业，去哪家公司，中午吃什么，等等。这些事情，都让选择困难症的我们头很大。那么，有算法能够很好地对付这些问题吗？

当然有！那就是bandit算法！

![MAB问题](/images/Data/algorithm/bandit-and-recommender-systems/image.png)
...
![](/images/Data/algorithm/bandit-and-recommender-systems/simulation.png)

算法效果对比一目了然：UCB算法和Thompson采样算法显著优秀一些。

至于你实际上要选哪一种bandit算法，你可以选一种bandit算法来选bandit算法。。。

# 2. bandit算法与线性回归{#bandit-2}
...
## 2.2 UCB算法加入特征信息{#ucb-2-2}

Yahoo!的科学家们在2010年发表了一篇论文^[http://www.research.rutgers.edu/~lihong/pub/Li10Contextual.pdf]，给UCB引入了特征信息，同时还把改造后的UCB算法用在了Yahoo!的新闻推荐中，算法名叫LinUCB。

刘鹏博士在《计算广告》一书中也有介绍LinUCB在计算广告中的应用^[《计算广告：互联网商业变现的市场与技术》p253, 刘鹏，王超著]。

![应用LinUCB算法的Yahoo!首页](/images/Data/algorithm/bandit-and-recommender-systems/image_0000.png)
...
![LinUCB算法描述](/images/Data/algorithm/bandit-and-recommender-systems/image_0001.png)
...
## 2.4 怎么构建特征{#construction-features}
...
![COFIBA算法描述](/images/Data/algorithm/bandit-and-recommender-systems/image_0002.png)
...
![User和Item聚类更新描述](/images/Data/algorithm/bandit-and-recommender-systems/image_0003.png)
