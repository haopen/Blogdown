---
title: 《廖雪峰 Python 教程》笔记 6：调试
date: 2017-06-18
categories: ["4-Python"]
tags: ["4-Python", "4-Debug", "4-调试"]
slug: Python-Debug
---
...
就可以输出一段文本。运行，发现除了`ZeroDivisionError`，没有任何信息。怎么回事？
...
另外，[Eclipse](http://eclipse.org/) 加上[`pydev`](http://pydev.org/)插件也可以调试 Python 程序。